...
numLinha = parseInt(prompt("Digite o número de linhas para subtração da primeira matriz: "));
numColunas = parseInt(prompt("Digite o número de colunas para subtração da primeira matriz: "));
...
numLinha = parseInt(prompt("Digite o número de linhas para subtração da segunda matriz: "));
numColunas = parseInt(prompt("Digite o número de colunas para subtração da segunda matriz: "));
